...
Install on Android: download the APK from [downloads.ramonvanbruggen.nl/app](https://downloads.ramonvanbruggen.nl/app/opennova-v1.1.30.apk) (the app updates itself from there afterwards). Install on iOS: TestFlight invite from the maintainer; Apple does not allow direct installs.
