...
start)
  ...
  rm /root/novabot/data/iox.log
  nohup iox-roudi  -c /root/novabot/shm_config/shm_ioxroudi.toml --log-level verbose > /root/novabot/data/iox.log &
  ...
  ros2 launch path_record path_record.launch.py record_with_start:=False   use_sim_time:=False &
